...
|---------|-------------|---------|------------|
| I01 | `MW_01` | 判断（橱柜+电源） | `MW_02` / `MW_03` / `MW_04` |
...
|------|--------|---------|--------------|
| 是的 | → 派工 | 派工 | `MW_01 --是的--> MW_02` ✓ |
| 没有 | → 建议暂缓 | 暂缓/改造 | `MW_01 --没有--> MW_03` ✓ |
| 独立式 | → 派工 | 派工 | `MW_01 --独立式--> MW_04` ✓ |
| 其他无法识别 | →【越界退出】 | 越界 | 无对应边 |
